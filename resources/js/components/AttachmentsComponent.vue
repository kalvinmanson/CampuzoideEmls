<template>
  <div>
    <div class="row">
      ...
      <form class="col-md-5 ml-auto" method="POST" action="/attachments" enctype="multipart/form-data">
    ...
    <div class="card-columns">
        <div class="card" v-for="attachment in attachmentsList">
          <a v-on:click="use(attachment)">
            <img :src="'/storage/'+attachment.thumbnail" class="img-fluid">
          </a>
          <div class="card-footer">
            {{ attachment.name }}
            <form :action="'/attachments/'+attachment.id" method="POST" class="float-right">
